...
public class RoomTypeEntry : IWeighted
{
    ...
    [Tooltip("Combine multiple rooms with same collision and entry type into a grouping. Take into account the orientation after being placed (Entry node placement).")]
